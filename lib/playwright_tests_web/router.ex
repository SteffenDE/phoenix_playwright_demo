defmodule PlaywrightTestsWeb.Router do
  use PlaywrightTestsWeb, :router

  import PlaywrightTestsWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {PlaywrightTestsWeb.LayoutView, :root}
  ...
  # scope "/api", PlaywrightTestsWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: PlaywrightTestsWeb.Telemetry
    end
  end
